...
class wallet_api
{
   public:
      ...
      annotated_signed_transaction burn(string account, asset amount, string memo, bool broadcast );

      annotated_signed_transaction root_burn(string account, asset amount, string memo, bool broadcast );
...
//      uint64_t get_account_transfer_history_count( string account, uint32_t type );
      ...
      map<uint32_t,applied_operation> get_account_pth_symbol_transfer_history( string account, string symbol, uint32_t from, uint32_t limit );
      ...
      annotated_signed_transaction set_mining_account(string account, bool broadcast);
      annotated_signed_transaction set_swap_account(string account, bool broadcast);
      annotated_signed_transaction transfer_mining_reward(string from, string to, asset amount, string memo, bool broadcast );
      annotated_signed_transaction mine(string account, asset amount, string memo, bool broadcast );
      annotated_signed_transaction swap(string from, string to, asset amount, string memo, bool broadcast );
...
FC_API( sigmaengine::wallet::wallet_api,
        ...
        ( get_account_pth_symbol_transfer_history )
