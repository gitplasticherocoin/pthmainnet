...
void database::initialize_evaluators()
{
   ...
   _my->_evaluator_registry.register_evaluator< mining_evaluator                             >();
   _my->_evaluator_registry.register_evaluator< set_swap_account_evaluator                   >();
   _my->_evaluator_registry.register_evaluator< swap_evaluator                               >();
   _my->_evaluator_registry.register_evaluator< root_burn_evaluator                          >();
}
