...
#define SIGMAENGINE_VERSION                                         ( version(0, 1, 17) )
...
#define SIGMAENGINE_INIT_PUBLIC_KEY_STR                             "PHK6tAnSH52vnszMcbnT1YK6D3qPa1dMcLtvxznjJUUyGkRYgiftZ" // 5HsG6FJRQC7jGL99nwzAqS1Q1t9cuJGMvzhL9P8SQubG17bXgt9
#define SIGMAENGINE_CHAIN_ID                                        (fc::sha256::hash("pth_mainnet2")) //(sigmaengine::protocol::chain_id_type())
#define SGT_SYMBOL                                                  (uint64_t(SIGMAENGINE_BLOCKCHAIN_PRECISION_DIGITS) | (uint64_t('P') << 8) | (uint64_t('T') << 16) | (uint64_t('H') << 24) )
#define SIGMAENGINE_ADDRESS_PREFIX                                  "PHK"
#define SIGMAENGINE_GENESIS_TIME                                    (fc::time_point_sec(1674604800))
...
#define SIGMAENGINE_SWAP_ACCOUNT                                     "swap"
