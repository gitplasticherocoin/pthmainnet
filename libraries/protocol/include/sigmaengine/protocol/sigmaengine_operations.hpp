...
namespace sigmaengine { namespace protocol {
    ...
    * @ingroup operations
    *
    * @brief Transfers PTH from one account to another.
    */
   ...
   struct mining_operation : public base_operation
   {
      account_name_type mine_account;
      asset             amount;
      string            memo;

      void              validate()const;
      void get_required_active_authorities( flat_set<account_name_type>& a )const{ a.insert(mine_account); }
   };

   struct set_swap_account_operation : public base_operation
   {
      account_name_type root;
      account_name_type account;
   ...
   struct swap_operation : public base_operation
   {
      account_name_type from;
      account_name_type to;
      asset             amount;
   ...
   struct root_burn_operation : public base_operation
   {
      account_name_type root;
      account_name_type account;
      asset             amount;
...
FC_REFLECT( sigmaengine::protocol::burn_operation, (account)(amount)(memo) )
FC_REFLECT( sigmaengine::protocol::vote_transaction_fee_operation, (voter)(trx_fee) )

FC_REFLECT( sigmaengine::protocol::set_mining_account_operation, (root)(account))
...
FC_REFLECT( sigmaengine::protocol::mining_operation, (mine_account)(amount)(memo) )
FC_REFLECT( sigmaengine::protocol::set_swap_account_operation, (root)(account))
FC_REFLECT( sigmaengine::protocol::swap_operation, (from)(to)(amount)(memo) )

FC_REFLECT( sigmaengine::protocol::root_burn_operation, (root)(account)(amount)(memo) )
