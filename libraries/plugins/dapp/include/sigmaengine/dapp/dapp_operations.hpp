...
namespace sigmaengine { namespace dapp {
   ...
   struct nsta602_approve_operation : public base_operation
   {
      account_name_type    owner;
      dapp_name_type       approved_dapp;
   ...
   DEFINE_PLUGIN_EVALUATOR( dapp_plugin, dapp_operation, nsta602_approve )
...
FC_REFLECT( sigmaengine::dapp::nsta602_approve_operation,
   ( owner )
   ( approved_dapp )
   ( dapp_name )
   ( author )
