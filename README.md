...
```
git clone https://github.com/gitplasticherocoin/pthmainnet.git
...
## Linux
1. Move to the directory where the pthd file is located, execute the node program with the following command
   > ./pthd
...
```
      ...
      unlocked >>> transfer test001 test002 "100.00000000 PTH" "" true
```
